...
> Discord reminder bot, schedule DM or channel alerts 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

⏰ &nbsp;**Precise timing** — set reminders down to the minute

🔁 &nbsp;**Recurring** — daily, weekly, monthly reminders

📋 &nbsp;**Reminder list** — view and manage all your reminders

🌍 &nbsp;**Timezones** — works across all timezones

👥 &nbsp;**Group reminders** — remind a whole channel or role

✅ &nbsp;**Snooze** — snooze a reminder with a button click
